  ...
  return (
    <div className="card bg-dark text-light mb-3 d-inline-block m-3 p-2" style={{maxWidth: "345px"}}>
      ...
      <div className="card-body">
        ...
        <p className="card-text">{description?description.slice(0,90):"News about something that happened somewhere somehow with someone or something by someone or something."}</p>
